...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ms.RepositorySample.Framework.OutBoxEventItem", b =>
                {
            ...
            modelBuilder.Entity("Ms.RepositorySamples.Domain.Categories.Entities.Category", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Ms.RepositorySamples.Domain.Products.Entities.Discount", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Ms.RepositorySamples.Domain.Products.Entities.Product", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Ms.RepositorySamples.Domain.Products.Entities.Discount", b =>
                {
                    b.HasOne("Ms.RepositorySamples.Domain.Products.Entities.Product", null)
                        .WithMany("Discounts")
